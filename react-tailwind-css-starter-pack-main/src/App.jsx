...
function App() {
  ...
  return (
   <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151]  flex-col gap-10 ">
    ...
    <div className=" bg-white justify-center gap-12 py-3 rounded-sm text-[20px] flex flex-row">
      <button className="border-r-2 text-center w-20 border-[#bfbfbf] text-5xl" onClick={decreasdeHandler}> - </button>
